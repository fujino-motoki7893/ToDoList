  ...
  <div>
      ...
      <div class="flex flex-col py-25 w-240">
        ...
        <div class="text-[40px] flex-col py-8 pr-16">
          <span class="text-[24px] leading-[1.67] tracking-[4px]">
            ...
            <p>
              座右の銘は「メンタリティとお気に入りのプレイリストさえあれば生きていける」です。えへへ ^ ^
            </p>
          </span>
        </div>
      </div>
    </div>
    <div class="flex h-[622px]">
      <div class="text-[40px] w-[418px] flex justify-center font-bold px-16">
        たいせつなこと
      </div>
      <div class="flex flex-col w-[1438px] leading-[1.67] tracking-[4px] pr-16">
    ...
    <div class="flex h-100">
      ...
      <div class="flex flex-col w-[1438px] pr-16 text-[24px] tracking-[4px]">
        ...
        <div class="flex">
          <span class="font-bold w-[198px]">
            フロントエンド...
          </span>
          <p class="pb-5 w-[1220px]">
